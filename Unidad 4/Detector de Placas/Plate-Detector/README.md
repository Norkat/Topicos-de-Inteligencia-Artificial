...
## Resumen
El frontend fue realizado en ReactNative junto con Expo.
Para poder correr el frontend es necesario instalar en el telefono movil Expo Go, correr el frontend y escanear el codigo QR para poder usarlo.
